...
// Shortening the mocha property of the Catppuccin class to theme for easier usage
/// A shortened reference to the `Catppuccin.mocha` , using the `mocha` property to define the theme.
final theme = Catppuccin.mocha;

/// The dark theme for the app, based on the Catppuccin theme color palette.
